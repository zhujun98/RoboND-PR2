...
def capture_sample():
    ...
    """
    get_model_state_prox = rospy.ServiceProxy(
        'gazebo/get_model_state', GetModelState)
    model_state = get_model_state_prox('training_model','world')

    set_model_state_prox = rospy.ServiceProxy(
...
def initial_setup():
    ...
    get_physics_properties_prox = rospy.ServiceProxy(
    ...
    set_physics_properties_prox = rospy.ServiceProxy(
